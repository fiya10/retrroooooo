...
def product_detail(request, category_slug, slug):
    ...
    images = [{'thumbnail': product.thumbnail.url, 'image': product.image.url}]
    for image in product.images.all():
        images.append({'thumbnail': image.thumbnail.url, 'image': image.image.url})

    imagesstring = json.dumps(images)
